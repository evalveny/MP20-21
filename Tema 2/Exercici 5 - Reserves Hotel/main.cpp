...
float testConstructorCopia(ReservesHotel& reserves)
{
	float reduccio = 0.0;
	...
	cout << endl <<  "Comment :=>> Inicialitzant nou objecte ReservesHotel amb constructor de copia....." << endl;

	ReservesHotel copia(reserves);

	cout << endl << "Comment :=>> Iniciant test metode CONSULTARESERVA a l'objecte inicialitzat amb la copia....." << endl;

	reduccio = testConsultaReserva(copia);
...
float testOperadorAssignacio(ReservesHotel& reserves)
{
	float reduccio = 0.0;
	...
	cout << endl << "Comment :=>> Inicialitzant nou objecte ReservesHotel amb operador assignacio....." << endl;

	ReservesHotel assignacio;

	assignacio = reserves;

	cout << endl << "Comment :=>> Iniciant test metode CONSULTARESERVA a l'objecte inicialitzat amb operador assignacio....." << endl;

	reduccio = testConsultaReserva(assignacio);
...
int main()
{
	...
	reduccio = testNReservesDia(reserves);
	grade += (1.0 - reduccio);
	if (grade < 0)
		grade = 0.0;
	cout << endl << "Grade :=>> " << grade << endl << endl;

	reduccio = testAfegeixReserva(reserves);
	grade += (2.0 - reduccio);
	if (grade < 0)
		grade = 0.0;
	cout << endl << "Grade :=>> " << grade << endl << endl;
	...
	reduccio = testConsultaReserva(reserves);
	grade += (2.0 - reduccio);
	if (grade < 0)
		grade = 0.0;
	cout << endl << "Grade :=>> " << grade << endl << endl;

	reduccio = testConstructorCopia(reserves);
	grade += (2.5 - reduccio);
	if (grade < 0)
		grade = 0.0;
	cout << endl << "Grade :=>> " << grade << endl << endl;

	reduccio = testOperadorAssignacio(reserves);
	grade += (2.5 - reduccio);
	if (grade < 0)
		grade = 0.0;
	cout << endl << "Grade :=>> " << grade << endl << endl;
